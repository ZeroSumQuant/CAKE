...
"""
    ...
    def test_extract_tasks(self, parser):
        ...
        parser._extract_task_from_sentence = Mock(
            return_value="implement a parser for conversations"
        )
...
"""
    ...
    def test_extract_problems_and_solutions(self, parser):
        ...
        parser._extract_assistant_content(
            turn_solution, mock_doc_solution, context, current_tasks, current_problems
        )
...
"""
    ...
    def test_confidence_scoring(self, parser):
        ...
        # Add decision
        decision = ExtractedDecision(text="use spacy", rationale="it's deterministic")
...
"""
    ...
    def test_implementation_linking(self, parser):
        ...
        turn1 = ConversationTurn(
            speaker="human", content="We need to create a parser", turn_number=0
        )
